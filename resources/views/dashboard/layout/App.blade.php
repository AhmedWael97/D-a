                        ...
                        <ul class="list-unstyled">
                            <li class="active"><a href="#dropdown-db" aria-expanded="true" data-toggle="collapse"><i class="la la-columns"></i><span>Home</span></a>
                                <ul id="dropdown-db" class="collapse list-unstyled show pt-0">
                                    <li><a class="active" href="db-default.html">Section 1</a></li>
                                    <li><a href="db-clean.html">Section 2</a></li>
                                    <li><a href="db-compact.html">Section 3</a></li>
                                    <li><a href="db-modern.html">Section 5</a></li>
                                    <li><a href="db-social.html">Footer</a></li>
                                </ul>
                            </li>
